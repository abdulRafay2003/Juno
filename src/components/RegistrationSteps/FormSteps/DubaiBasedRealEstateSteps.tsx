...
interface DubaiBasedRealEstateStepsProps {
...
const DubaiBasedRealEstateSteps = ({
  selectedSteps,
  control,
  errors,
  watch,
  ...
  heading,
  setError,
}: DubaiBasedRealEstateStepsProps) => {
  const handleStepSubmit = async (formData: any) => {
    let submitData: any = {
      category: ONBOARDING_CATEGORIES.REAL_ESTATE_AGENCY_DUBAI_BASED,
      data: {},
    };
    ...
    switch (selectedSteps) {
      case 1:
        ...
        submitData.data = {
          ...
          rera_registration_expiry_date: formData.companyReraRegistrationExpiry,
      ...
      case 4:
        ...
        submitData.data = {
          // Document fields will be handled by StepFour component
          valid_trade_license: formData.validTradeLicense,
          passport_copy: formData.passportCopy,
          rera_certificate: formData.reraCertificate,
          broker_card: formData.brokerCard,
...
export default DubaiBasedRealEstateSteps;
