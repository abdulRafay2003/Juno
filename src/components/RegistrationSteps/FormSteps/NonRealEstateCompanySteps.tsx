...
interface NonRealEstateCompanyStepsProps {
...
const NonRealEstateCompanySteps = ({
  selectedSteps,
  control,
  errors,
  watch,
  ...
  heading,
  setError,
}: NonRealEstateCompanyStepsProps) => {
  const handleStepSubmit = async (formData: any) => {
    let submitData: any = {
      category: ONBOARDING_CATEGORIES.NON_REAL_ESTATE_COMPANY,
      data: {},
    };
    ...
    switch (selectedSteps) {
      ...
      case 4:
        ...
        submitData.data = {
          ...
          bank_account_stamp: formData.bankAccountStamp,
...
export default NonRealEstateCompanySteps;
