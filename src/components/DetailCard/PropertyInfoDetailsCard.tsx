...
const PropertyInfoDetailsCard: React.FC<LeadsCardProps> = ({
  title,
  customStyles,
  customFontStyles,
  details,
    ...
    <View style={[styles.card, customStyles]}>
      ...
      <View style={styles.listContainer}>
        ...
        <CustomText.LargeSemiBoldText
          numberOfLines={2}
          customStyle={[styles.valueText, customFontStyles]}>
          {details?.unit?.number_of_bedrooms || '-'}
        </CustomText.LargeSemiBoldText>
      </View>
      ...
      <View style={styles.listContainer}>
        ...
        <CustomText.LargeSemiBoldText
          numberOfLines={2}
          customStyle={[styles.valueText, customFontStyles]}>
          {details?.unit?.price ? formatPricing(details?.unit?.price) : '-'}
        </CustomText.LargeSemiBoldText>
      </View>
    </View>
  );
...
export default PropertyInfoDetailsCard;
