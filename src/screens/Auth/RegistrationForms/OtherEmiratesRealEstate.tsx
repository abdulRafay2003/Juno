...
import {
  step1OtherEmiratesSchema,
  step2OtherEmiratesSchema,
  step3OtherEmiratesSchema,
  step4OtherEmiratesSchema,
...
import OtherEmiratesRealEstateSteps from '@/components/RegistrationSteps/FormSteps/OtherEmiratesRealEstateSteps';
...
const OtherEmiratesRealEstate = () => {
  ...
  const getStepDataQuery = useQuery({
    queryKey: ['onboardingOtherEmirates', selectedSteps],
...
export default OtherEmiratesRealEstate;
